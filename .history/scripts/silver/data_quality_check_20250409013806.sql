...
-- Check id from bronze.erp_px_cat_g1v2
SELECT distinct id FROM bronze.erp_px_cat_g1v2

-- erp table has _ crm table has - 
-- lets replace the - with _ 
SELECT prd_id,
prd_key,
...
-- Filter out unmatched category id that is not present in the product info table
SELECT prd_id,
prd_key,
REPLACE(SUBSTRING(prd_key,1 ,5), '-', '_') AS cat_id,
prd_nm,
